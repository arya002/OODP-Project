                    ...
                    case 1:
                        ...
                        switch (sc_in) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                if(printMovies(MovieControl.getAllMoviesByRating()));
                                //TODO print top 5
                                break;
                        }
                        System.out.println();
                    ...
                    case 2:
                        ...
                        while (!mov.equals("exit")) {
                            ...
                            while (counter < MovieControl.getAllMovies().size()) {
                                ...
                                if (mov.equals("exit")) {
                                    break;
                                } else if (searchedMovie == null || counter >= MovieControl.getAllMovies().size()) {
...
/*
    ...
    */
    ...
    private boolean printMovies(ArrayList<Movie> movies) {
        if (movies.size() != 0) {
